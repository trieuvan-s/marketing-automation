...
- **LUÔN** nối phần **§1 (Luật giọng), §2 (Chiêu chữ ký), §3 (Nên/Tránh)** vào mọi system prompt sản xuất.
- **CHỌN 1 ví dụ hợp format** ở §5 để làm few-shot, đừng nhồi cả ba (tiết kiệm context):
  - **Bài tin từ báo cáo/khuyến nghị công ty chứng khoán → Ví dụ D (anchor chuẩn, ưu tiên)**
  - Bài viết phân tích trung/dài → Ví dụ A hoặc B
  - Post Facebook / caption ngắn → Ví dụ C
  - Kịch bản video → Ví dụ C cho phần hook + §4 (chuyển thể)
  - Copy infographic → §4 (chuyển thể) + tiêu đề Ví dụ A/C
...
## 2. Sáu chiêu chữ ký (khung xương mỗi bài)

Đây là trình tự đã lặp ở cả ba bài. Không cần đủ 6 mỗi lần, nhưng **Mở-nghịch-lý** và **Kết-mở**
gần như bắt buộc.

1. **MỞ BẰNG NGHỊCH LÝ** — xem **Menu hook (§2b)**. Câu mở là mâu thuẫn/hình ảnh nén, kết bằng
   một câu hỏi hoặc ngã ba, KHÔNG nhồi cả nghịch lý vào một câu dài.
   - **Cấm** mở bằng "Trong bối cảnh…", "Thời gian gần đây…", "Như chúng ta đã biết…".
2. **DỰNG ĐỐI LẬP TRƯỚC (steelman)** — cho phía lo ngại/phản đối lý lẽ đầy đủ, công bằng:
   *"Mối lo ấy có cơ sở thật."* Không bao giờ dựng bù nhìn để đập.
3. **BƯỚC LÙI** — câu chuyển hướng đặc trưng: *"Đọc đến đây, dễ dừng lại ở kết luận X. Nhưng nếu
   lùi một bước và hỏi câu khác…"*
4. **SUY LUẬN NGƯỢC** — động cơ phân tích của cả ba bài. Hai cách diễn đạt, chọn theo format:
   - *Bài dài / dạy cách đọc:* để nguyên câu hỏi meta — *"Phải tin điều gì thì nước đi này mới
     hợp lý trong mắt người ra quyết định?"*
   - *Bài tin ngắn:* **hoá câu hỏi thành khẳng định điều kiện cho mượt** — *"Điều đó chỉ hợp lý nếu
     họ không đặt cược vào nền kinh tế, mà đặt cược vào câu chuyện riêng của từng doanh nghiệp."*
     (Đừng trích nguyên văn câu hỏi meta giữa thân bài tin — nó làm khựng nhịp.)
5. **TỔNG HỢP "CẢ HAI CÙNG ĐÚNG"** — không chọn phe: *"Nỗi lo của chuyên gia và logic chiến lược
   không mâu thuẫn nhau. Cả hai cùng đúng."* Rồi nâng lên câu hỏi thật (rủi ro dời về đâu, ai đỡ).
6. **KẾT MỞ** — đóng bằng *điều đáng theo dõi* (liệt kê 2–3 biến số cần quan sát) hoặc một câu hỏi
   thả cho người đọc. **Không** chốt phán quyết mua/bán.
   ...
   - **Được phép thêm ĐÚNG MỘT câu chốt-nguyên-lý** sau phần kết mở: một bài học về *cách nghĩ*,
     ngắn và quotable, KHÔNG phải khuyến nghị hành động. Ví dụ:
     *"Đầu tư không chỉ là chọn cổ phiếu tốt, mà là hiểu vì sao thị trường chọn chúng."*
     (Giống câu "mỗi mũi tên bắn được nhiều con chim" ở bài dài — dạy tư duy, không phán giá.)

**Nhịp câu:** dùng câu chốt một dòng đứng riêng để đánh dấu khúc ngoặt —
