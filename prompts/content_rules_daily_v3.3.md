...
**Đổi so với v3.2:** thêm Phần II Không gian sáng tạo · thêm Nguyên tắc cuối cùng · đánh số lại các phần sau.
...
**Ghi nguồn và disclaimer bắt buộc với mọi sản phẩm xuất bản công khai:** "Nội dung mang tính tham khảo, không phải khuyến nghị đầu tư."

⚠️ Infographic: renderer đã đóng cứng dòng này vào band đáy, Composer không cần đưa vào JSON. **Article và Video Script chưa có cơ chế tự động — Composer phải tự đưa vào.**
...
- Kết đoạn trước bằng một vấn đề còn mở, đoạn sau đi thẳng vào đó.
- Dùng một chi tiết cụ thể để bắc từ số liệu sang tác động.
- Đặt hai hiện tượng cạnh nhau, để người đọc tự thấy mâu thuẫn.
- Mở đoạn bằng chủ thể thật: "Nhóm ngân hàng...", "Một doanh nghiệp cảng...".
- Câu ngắn để đổi nhịp: "Phần khó nằm ở đây."
...
Không dùng từ chỉ mức độ lớn khi dữ kiện không chứng minh được mức độ đó. Không dùng nhiều tính từ để che chỗ thiếu dữ kiện.

- "hạ tầng tạo động lực mạnh mẽ" → "cao tốc mới rút ngắn thời gian giao hàng và giảm chi phí tồn kho"
- "công nghệ nâng cao hiệu quả" → "hệ thống dữ liệu giúp doanh nghiệp phát hiện lỗi sớm hơn"
...
Bảy câu, tự trả lời trong đầu. **Không xuất ra cùng sản phẩm.**
...
7. Có từ nào trong §1.4.2 không? Article và Video Script đã có nguồn và disclaimer chưa?
