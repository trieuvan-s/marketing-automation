...
- "disclaimer": PHẢI dùng ĐÚNG NGUYÊN VĂN "Nội dung mang tính tham khảo, không phải khuyến nghị đầu tư." (KHÔNG viết lại/diễn giải/thêm bớt chữ nào — đây là câu miễn trừ trách nhiệm CHUẨN, đã duyệt).

KỶ LUẬT SỐ (BẮT BUỘC, Phase 4.13 — giảm NEEDS_HUMAN oan do tự chế số):
- MỌI số bạn viết PHẢI Y NGUYÊN VĂN như trong content_units[].raw (hoặc evidence nếu không có content_units) — KHÔNG tự CỘNG/GỘP nhiều số RIÊNG LẺ thành 1 số MỚI (vd evidence có '89.000 tỷ đồng' và '125.000 tỷ đồng' ở 2 câu KHÁC NHAU -> CẤM tự cộng ra '214.000 tỷ đồng' hay bất kỳ số tổng nào KHÔNG có sẵn nguyên văn trong content_units[]/evidence).
...
- Muốn dùng SỐ TỔNG (vd tổng nhiều khoản) -> CHỈ dùng nếu con số tổng đó ĐÃ có sẵn NGUYÊN VĂN trong content_units[]/evidence (ai đó đã tính sẵn và công bố) — KHÔNG tự làm phép cộng/trừ/nhân/chia rồi trình bày như số THẬT của nguồn.
